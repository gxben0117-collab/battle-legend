...
assertIncludes(indexHtml, 'function isPurchasableCard', 'shop purchasable-card filter');
assertIncludes(indexHtml, 'atkSpd: template.atkSpd || template.spd', 'attack speed stat');
